...
RSpec.describe 'the Admin Shelters Index' do
  ...
  it 'section for pending apps shows shelters listed alphabetically' do
    ...
    within("#pending_apps") do
      expect(page).to have_content("Marquette Humane Society")
      expect(page).to have_content("San Antonio Humane Society")
    end
  end
  ...
  it 'every shelter name is a link, takes to admin shelter show page' do
    ...
    expect(current_path).to eq("/admin/shelters/#{@shelter6.id}")
  end
end